    ...
    <div class="bg-gray-50 min-h-screen">
        <div class="absolute top-0 left-0 opacity-80">
            <div class="p-3 flex items-center">
                <svg class="w-6 h-6 text-gray-600 fill-current mr-1" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                     x="0px" y="0px"
                ...
                <span class="text-md text-gray-600 font-semibold">SponsorShip</span>
            </div>
        </div>
        <div class="max-w-2xl mx-auto px-6 pt-24 pb-28">
            <h1 class="text-3xl text-center text-gray-600 font-medium mb-8">Which episodes would you like sponsor?</h1>
            <ul>
                @foreach(range(1, 4) as $i)
                <li class="mb-4">
                    <div class="flex justify-between bg-white rounded-lg shadow p-4 group border-2 border-transparent hover:border-indigo-400 select-none cursor-pointer">
                        <div class="w-3/4 flex items-center justify-between">
                            <div class="flex items-center">
                                <img class="block w-16 h-16 rounded mr-4" src="https://fullstackradio.com/podcast-cover.jpg" alt="Radio Logo">
                                <div>
                                    <div class="text-lg font-bold text-gray-700">Full Stack Radio: Episode {{ 88 + $i }}</div>
                                    <div class="text-sm text-gray-600">June, 6 2018</div>
                                </div>
                            </div>
...
{{--                            <i class="fas fa-check-circle text-2xl text-green-400"></i>--}}
        ...
        <div class="bg-white border-t-2 border-gray-300 fixed bottom-0 w-full">
            <div class="max-w-2xl mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    <div class="w-3/4 flex justify-between items-center pr-2">
                        <div class="text-lg text-gray-700">1 episode selected</div>
                        <div class="text-right">
                            <div class="text-lg font-bold text-gray-700">$500</div>
                            <div class="text-sm text-gray-600">USD</div>
                        </div>
                    ...
                    <div class="w-1/4 flex justify-end items-center">
                        <button type="button" class="rounded-md px-5 py-2 leading-normal text-md font-bold text-white bg-indigo-700 hover:bg-indigo-400">Pay Now</button>
                    </div>
                </div>
            </div>
        </div>
