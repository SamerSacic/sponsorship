<template>
  <div>
        ...
        <div class="max-w-2xl mx-auto px-6 py-4">
          <div class="flex justify-between items-center">
            <div class="w-3/4 flex justify-between items-center pr-2">
              <div class="text-lg text-gray-700">{{ selectedSlots.length }} {{ selectedSlots.length === 1 ? 'episode' : 'episodes' }} selected</div>
              <div class="text-right">
                <div class="text-lg font-bold text-gray-700">${{ totalInDollars }}</div>
    ...
    <div v-show="false" class="fixed top-0 left-0 bottom-0 right-0 flex justify-center items-center p-6" style="background-color: rgba(0, 0, 0, 0.2);">
    ...
    data() {
      return {
        ...
        sponsorableSlots: [
          {
            id: 1,
          	title: 'Full Stack Radio: Episode 89',
